<template>
  <div class="flex flex-col items-center justify-start bg-gradient-to-b from-[var(--color-gradient-onboarding-start)] to-[var(--color-gradient-onboarding-end)] to-40% rounded-lg overflow-hidden pb-4">
